...
namespace Unity.Services.Mediation.Samples
{
    ...
    public class RewardedExample : MonoBehaviour
    {
        ...
        public IRewardedAd m_RewardedAd;
        Action onRewardedAdSuccess;
        Action onRewardedAdFail;
        ...
        public async void ShowRewarded(Action onSuccess = null, Action onFail = null)
        {
            if(onSuccess != null) { onRewardedAdSuccess = onSuccess; }
            if(onFail != null) { onRewardedAdFail = onFail; }
