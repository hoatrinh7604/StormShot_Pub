...
Shader "Shader Graphs/Dissolve"
{
  Properties
  {
    _AlbedoColor ("AlbedoColor", Color) = (0.3176471,0.3921569,1,0)
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: Pass
    {
      ...
      uniform UnityPerMaterial 
          ...
          uniform float _AlphaClipThreshhold;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = in_f.texcoord.xyxy * float4(_NoiseScale);
          ...
          u_xlat1_d.x = u_xlat0_d.w + (-_AlphaClipThreshhold);
          ...
          if(u_xlatb1)
      {
          ...
          u_xlat0_d.xyz = _AlbedoColor.xyz;
    ...
    Pass // ind: 2, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = in_f.texcoord1.xyxy * float4(_NoiseScale);
          ...
          u_xlat0_d.x = u_xlat0_d.x + (-_AlphaClipThreshhold);
    ...
    Pass // ind: 4, name: DepthNormals
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = in_f.texcoord2.xyxy * float4(_NoiseScale);
